...
export const Navigation = () => {
  ...
  const scrollToSection = (href) => {
    ...
    if (elem) {
      const navHeight = 60;
      const elemPosition = elem.offsetTop - navHeight;
      window.scrollTo({
        top: elemPosition,
        behavior: "smooth"
      });
  ...
  return (<nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white/95 backdrop-blur-md shadow-sm" : "bg-transparent"}`}>
